...
class vars:
    ...
    def plot_BL(self, fig, ax):
        ...
        ax.set_ylabel('$u^+$')
        ax.set_xlabel('$y^+$')
        ax.axis([np.min(self.yp),1.1*end,0,30])
...
# Extract the data
v52 = vars("../data/v2fResults_5200.dat",5200)
v10 = vars("../data/test/v2fResults_10000.dat",10000)

# Find the log-law parameters
mask = np.where((v10.yp > 30))
logy = np.log(v10.yp[mask])
u_in_log = v10.U[mask]
slope, intercept, r, p, err  = stats.linregress(logy, u_in_log)
print("k = {0}".format(1.0/slope))
print("B = {0}".format(intercept))
print("r = {0}".format(r))
...
fig.savefig('../doc/turbulence/figs/loglaw_10000.png')
plt.show()

# Plot k, eps, v2, f
fig1, ax = plt.subplots()
v52.plot_U(fig1, ax, 'r', '5200')
v10.plot_U(fig1, ax, 'b', '10000')
ax.legend(loc='best')
fig1.tight_layout()
fig1.set_size_inches(7,5, forward=True)
fig1.savefig('../doc/turbulence/figs/U_10000.png')
plt.show()

fig2, ax = plt.subplots()
v52.plot_k_y(fig2, ax, 'r', '5200')
v10.plot_k_y(fig2, ax, 'b', '10000')
ax.legend(loc='best')
fig2.tight_layout()
fig2.set_size_inches(7,5, forward=True)
fig2.savefig('../doc/turbulence/figs/k_y_10000.png')
plt.show()

fig3, ax = plt.subplots()
v52.plot_k_yp(fig2, ax, 'r', '5200')
v10.plot_k_yp(fig2, ax, 'b', '10000')
ax.legend(loc='best')
fig3.tight_layout()
fig3.set_size_inches(7,5, forward=True)
fig3.savefig('../doc/turbulence/figs/k_yp_10000.png')
plt.show()

fig4, ax = plt.subplots()
v52.plot_eps(fig2, ax, 'r', '5200')
v10.plot_eps(fig2, ax, 'b', '10000')
ax.legend(loc='best')
ax.set_ylim([0,np.max(v10.eps)*1.1])
fig4.tight_layout()
fig4.set_size_inches(7,5, forward=True)
fig4.savefig('../doc/turbulence/figs/eps_10000.png')
plt.show()
